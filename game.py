    ...
    def player_input(self, key_pressed):
        ...
        if key_pressed[K_LEFT]:
            ...
            if self.map.map_tiles[x_][y_].can_walk:
                ...
                print 'change map to: '+ self.map.map_tiles[x_][y_].object.name
            ...
            elif self.map.map_tiles[x_][y_-1].object is not None and self.map.map_tiles[x_][y_].object.type == 'PORTAL':
                print 'change map to: '+ self.map.map_tiles[x_][y_].object.name
